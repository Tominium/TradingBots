...
api_key = 'PKBFALQY6VCQ1B3NW7W7'
api_secret = 'fkorNH8XcrqBQDa6WcMuNSz7FRlwAUgp1QAgY7Z9'
...
if clock.is_open:
    ...
    sleep(time_to_open.total_seconds() + 400)

i = 0
def get_stock():
    global i
    df = pd.read_json('https://robintrack.net/api/largest_popularity_increases?hours_ago=4&limit=50&percentage=false&min_popularity=50&start_index=0')
